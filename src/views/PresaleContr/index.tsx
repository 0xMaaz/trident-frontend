...
import { IPresaleContrSlice, getPresaleContrDetails, changeApproval, buyPresale, claimPresale } from "../../store/slices/presaleContr-slice";
import { trim } from "../../helpers";

function PresaleContr() {
    const dispatch = useDispatch();
    const { provider, address, connect, chainID, checkWrongNetwork } = useWeb3Context();

    const presaleContr = useSelector<IReduxState, IPresaleContrSlice>(state => state.presaleContr);
    ...
    const onSeekApproval = async () => {
        ...
        dispatch(getPresaleContrDetails({ provider, networkID: chainID, address }))
    };
    ...
    const isAllowed = useCallback(() => {
        return presaleContr.approvedContractAddress != "";
    }, [presaleContr.approvedContractAddress]);
